...
const ArtistSidebar = () => {
  ...
  return (
    <div className="bg-transparent w-auto flex flex-col items-center justify-normal">
      <nav
        id="sidenav-8"
      ...
      <MdOutlineMenu
        className="text-slate-900 text-2xl my-2 mx-1 md:mx-2 lg:mx-6 transition duration-150 ease-in-out cursor-pointer"
