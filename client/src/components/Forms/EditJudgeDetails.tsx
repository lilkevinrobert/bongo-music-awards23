...
const EditJudgeDetails = ({ details }: EditJudgeDetailsProps) => {
    ...
    const {
        ...
        defaultValues: {
            gender: details.user_information.gender,
            date_of_birth: details.user_information.date_of_birth ? new Date(details.user_information.date_of_birth).toISOString().split('T')[0] : '',
        }
    });
    ...
    const onSubmit = async (data: any) => {
        ...
        console.log(data)
        // axios
        //     .patch(`${BASE_URL}/user_informations`, modified_data, {
        //         headers: {
        ...
        <form className="pl-0" onSubmit={handleSubmit(onSubmit)}>
            ...
            <section className="py-2 pr-0">
                ...
                <div className="flex w-full flex-col gap-4 rounded-md bg-slate-50 p-4 lg:flex-row">
                    <div className="flex w-full flex-col gap-2 lg:w-4/12">
                        <label className="font-LatoBold text-base capitalize text-gray-900">
                            Profile Picture
                        </label>
                        {/* Display the previously uploaded file name if it exists */}
                        {details.user_information.profile_picture_url && (
                            <div className="flex flex-col w-36 h-36">
                                <img src={`${HOME_URL}/${details.user_information.profile_picture_url}`} alt={`${details.user_information.last_name} logo`} className="w-full h-full object-cover rounded font-LatoRegular text-sm hover:scale-105 transition ease-linear duration-300" />
                            </div>
                        )}
                        <Controller
                    ...
                    <div className="grid w-full grid-cols-1 items-center justify-between gap-2 md:grid-cols-2">
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.first_name}
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.middle_name}
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.last_name}
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <Controller
                                ...
                                render={({ field, fieldState }) => {
                                    return (
                                        <>
                                            <select {...field} value={field.value.toUpperCase()} className={`w-full h-[2.3rem] ${fieldState.invalid ? 'border-red-500' : 'border-gray-300'} font-LatoRegular text-sm rounded`}>
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.username}
                    ...
                    <div className="grid w-full grid-cols-1 items-center justify-between gap-2 md:grid-cols-2">
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.phone}
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <input
                                ...
                                defaultValue={details.user_information.email}
            ...
            <div className="mr-0 mb-10 flex flex-row items-center justify-end rounded-md bg-slate-200 px-4 py-4">
                <Button
                    size="sm"
                    type="submit"
